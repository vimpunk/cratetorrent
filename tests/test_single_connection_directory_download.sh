...
subdir1_path="${src_path}/subdir"
subdir2_path="${src_path}/subdir/subdir2"
file1_path="${src_path}/file1.txt"
file2_path="${src_path}/file2.txt"
file3_path="${subdir1_path}/file3.txt"
file4_path="${subdir2_path}/file3.txt"
...
download_file3="${download_subdir1}/file3"

download_subdir2="${download_subdir1}/subdir2"
download_file4="${download_subdir2}/file4"
